function roots = locate_real_roots(f, domain, partition_size, image_scale_factor)

  domain_partitions = domain(1):partition_size:domain(2);
  ...
  for i = 1 : (length(domain_partitions) - 1)
    max_image_range = image_scale_factor * partition_size;
